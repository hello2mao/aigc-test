...
def train():
    ...
    args = Namespace(
        ...
        instance_data_dir="./impulse_img",
        # The output directory where the model predictions and checkpoints will be written.
        output_dir="/root/individual/hello2mao/models/impulse_logo_img",  # where to save the pipeline        
        ...
        class_data_dir="/root/individual/hello2mao/models/impulse_logo-class-images",
        ...
        use_8bit_adam=False,  # use 8bit optimizer from bitsandbytes to lower the memory usage.
        # Flag to add prior preservation loss.
        with_prior_preservation=False, # see: https://github.com/huggingface/diffusers/blob/main/examples/dreambooth/README.md#training-with-prior-preservation-loss
        ...
        enable_xformers_memory_efficient_attention=False, # set this to True to lower the memory usage.
        #  "Save more memory by using setting grads to None instead of zero. Be aware, that this changes certain"
        #     " behaviors, so disable this argument if it causes any problems. More info:"
        #     " https://pytorch.org/docs/stable/generated/torch.optim.Optimizer.zero_grad.html"
        set_grads_to_none=False, # set this to True to lower the memory usage.
